        ...
        <div className="mt-3 flex flex-wrap gap-2">
          ...
          {selectedSummary?.coordinatorDecisionStatus && (
            ...
            >
              ...
              <b className="ml-1">
                {String(selectedSummary.coordinatorDecisionStatus)}
              </b>
            </span>
          )}
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div className="rounded-xl border border-white/10 bg-black/30 p-3">
              ...
              <p className="text-base font-bold text-white mt-1">
                {String(
                  selectedSummary?.coordinatorDecisionStatus ?? "PENDIENTE"
                )}
              </p>
            </div>
            ...
            <div className="rounded-xl border border-white/10 bg-black/30 p-3">
              <p className="text-[11px] uppercase tracking-widest text-neutral-500">
                Acción admin (placeholder)
              </p>
              <p className="text-xs text-neutral-400 mt-1">
                Botones para “Aprobar contratación” / “Rechazar” / “Solicitar
                revisión”.
              </p>
            </div>
          </div>
