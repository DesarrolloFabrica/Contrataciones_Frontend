  ...
  >
    <div className="flex items-start justify-between">
      <div className="space-y-1">
        ...
        >
            {isEdit ? <UserRound className="w-5 h-5 text-brand-500" /> : <Sparkles className="w-5 h-5 text-brand-500" />}
            {title}
        </h3>
        <p
          className={[
...
const Field = ({
  ...
  <div className="group space-y-2">
    <div className="flex items-end justify-between">
      <label className="text-xs font-medium text-zinc-400 group-focus-within:text-brand-400 transition-colors flex items-center gap-1.5">
          ...
          <div className="space-y-6">
            ...
            {!isEdit && step === "SUCCESS" && (
              <div className="space-y-6">
                ...
                >
                    <div className="p-2 bg-brand-500/10 rounded-full shrink-0">
                        <CheckCircle2
                          className={[
                            "w-5 h-5",
                    ...
                    <div>
                        <h4
                          className={[
                            ...
                            isDark ? "text-brand-100" : "text-brand-800",
                          ].join(" ")}
                        >
                          Usuario registrado
                        </h4>
                    ...
                    <Field 
                        ...
                        actions={
                            <button
                                ...
                                className="text-[10px] font-medium px-2 py-0.5 rounded bg-brand-500/10 text-brand-400 hover:bg-brand-500/20 transition-colors flex items-center gap-1.5"
                            >
            ...
            <div className="flex items-center gap-3">
                ...
                {step === 'SUCCESS' ? (
                     <button
                        ...
                        className="px-5 py-2.5 bg-brand-600 hover:bg-brand-500 text-white rounded-lg text-xs font-semibold shadow-lg shadow-brand-900/20 transition-all flex items-center gap-2 border border-brand-500/50"
                    >
                        Crear otro usuario
                    ...
                    <button
                        ...
                        className={`px-5 py-2.5 rounded-lg text-xs font-semibold shadow-lg transition-all flex items-center gap-2 ${
                            primaryDisabled 
                                ...
                                : "bg-brand-600 hover:bg-brand-500 text-white shadow-brand-900/20 border border-brand-500/50"
                        }`}
                    >
